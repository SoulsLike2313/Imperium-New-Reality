...
TUI_PATH = ADMIN_ROOT / "TUI" / "administratum_tui_v0_1.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run read-only smoke for Administratum TUI.")
