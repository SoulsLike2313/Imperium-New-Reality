...
Write-Host "== ROOT-QUARANTINE-LONGPATH-COMPACTION-0001-FIX-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Root quarantine longpath compaction FIX-0001 failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "ROOT QUARANTINE LONGPATH COMPACTION FIX-0001 PASS"
