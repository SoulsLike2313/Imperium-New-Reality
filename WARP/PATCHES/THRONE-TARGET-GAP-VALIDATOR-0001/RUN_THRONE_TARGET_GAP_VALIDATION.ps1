...
Write-Host "== THRONE-TARGET-GAP-VALIDATOR-0001 =="
...
if ($LASTEXITCODE -ne 0) {
  throw "Throne target gap validator failed with exit code $LASTEXITCODE"
}

Remove-Item -Recurse -Force "ORGANS\THRONE\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "THRONE TARGET GAP VALIDATION PASS"
