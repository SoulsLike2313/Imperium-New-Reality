...
$Validator = Join-Path $RepoRoot "ORGANS\ASTRONOMICON\VALIDATORS\validate_imperium_launcher_app_organ_hub_leveling_ui.py"

Write-Host "== IMPERIUM-LAUNCHER-APP-ORGAN-HUB-LEVELING-UI-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Imperium Launcher organ hub leveling UI validation failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\ASTRONOMICON\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM LAUNCHER ORGAN HUB LEVELING UI PASS"
