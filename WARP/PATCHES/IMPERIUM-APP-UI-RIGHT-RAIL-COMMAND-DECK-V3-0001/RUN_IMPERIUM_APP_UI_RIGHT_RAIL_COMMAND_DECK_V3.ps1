...
$Validator = Join-Path $RepoRoot "ORGANS\MECHANICUS\VALIDATORS\validate_imperium_app_ui_right_rail_command_deck_v3.py"

Write-Host "== IMPERIUM-APP-UI-RIGHT-RAIL-COMMAND-DECK-V3-0001 =="
...
if ($LASTEXITCODE -ne 0) {
  throw "Imperium App UI right rail command deck v3 failed with exit code $LASTEXITCODE"
}

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM APP UI RIGHT RAIL COMMAND DECK V3 PASS"
