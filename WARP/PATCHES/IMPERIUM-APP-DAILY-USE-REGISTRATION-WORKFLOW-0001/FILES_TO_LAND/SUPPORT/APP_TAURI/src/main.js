...
function renderAstronomicon() {
  ...
  return `<section class="room-panel astronomicon-intake-panel" data-marker="ASTRONOMICON_ROOM" data-picker-marker="${ASTRONOMICON_PATCH_PICKER_DARK_LIST_V0_1}">
    ...
    <p class="muted">Astronomicon registers candidate intent and shape. Mechanicus returns stack, monolith, visual and dependency verdict. Candidate packs do not run; polished packs must re-register before launch.</p>
