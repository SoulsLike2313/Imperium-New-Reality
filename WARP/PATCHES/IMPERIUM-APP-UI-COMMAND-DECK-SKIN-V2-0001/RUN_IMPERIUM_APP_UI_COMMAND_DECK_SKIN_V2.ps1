...
$Validator = Join-Path $RepoRoot "ORGANS\MECHANICUS\VALIDATORS\validate_imperium_app_ui_command_deck_skin_v2.py"

Write-Host "== IMPERIUM-APP-UI-COMMAND-DECK-SKIN-V2-0001 =="
...
if ($LASTEXITCODE -ne 0) {
  throw "Imperium App UI command deck skin v2 failed with exit code $LASTEXITCODE"
}

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM APP UI COMMAND DECK SKIN V2 PASS"
