...
Write-Host "== THRONE-TARGET-GAP-CORE-V1-SCORING-INTEGRATION-0001-FIX-0002 =="
...
if ($LASTEXITCODE -ne 0) { throw "Throne target gap Core v1 scoring FIX-0002 failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\THRONE\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "THRONE TARGET GAP CORE V1 SCORING FIX-0002 PASS"
