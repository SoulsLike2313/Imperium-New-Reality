...
$Validator = Join-Path $RepoRoot "ORGANS\MECHANICUS\VALIDATORS\validate_imperium_app_platform_ui_polish_hotfix.py"

Write-Host "== IMPERIUM-APP-PLATFORM-UI-POLISH-HOTFIX-0001 =="
...
if ($LASTEXITCODE -ne 0) {
  throw "Imperium App Platform UI polish hotfix failed with exit code $LASTEXITCODE"
}

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM APP PLATFORM UI POLISH HOTFIX PASS"
