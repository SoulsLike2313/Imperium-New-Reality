...
$Validator = Join-Path $RepoRoot "ORGANS\ASTRONOMICON\VALIDATORS\validate_imperium_app_tauri_shell_foundation.py"

Write-Host "== IMPERIUM-APP-TAURI-SHELL-FOUNDATION-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Imperium App Tauri shell foundation validation failed with exit code $LASTEXITCODE" }
Remove-Item -Recurse -Force "ORGANS\ASTRONOMICON\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue
Write-Host "IMPERIUM APP TAURI SHELL FOUNDATION PASS"
