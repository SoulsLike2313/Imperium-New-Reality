...
Write-Host "== IMPERIUM-TUI-WINDOWED-AQUARIUM-LAUNCHER-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Imperium TUI windowed aquarium launcher validation failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\ASTRONOMICON\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM TUI WINDOWED AQUARIUM LAUNCHER PASS"
