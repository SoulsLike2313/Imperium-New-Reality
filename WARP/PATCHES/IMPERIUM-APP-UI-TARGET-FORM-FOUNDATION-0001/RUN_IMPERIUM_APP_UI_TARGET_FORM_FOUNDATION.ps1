...
$Validator = Join-Path $RepoRoot "ORGANS\MECHANICUS\VALIDATORS\validate_imperium_app_ui_target_form_foundation.py"

Write-Host "== IMPERIUM-APP-UI-TARGET-FORM-FOUNDATION-0001 =="
...
if ($LASTEXITCODE -ne 0) {
  throw "Imperium App UI target form foundation failed with exit code $LASTEXITCODE"
}

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "IMPERIUM APP UI TARGET FORM FOUNDATION PASS"
