...
Write-Host "== GOVERNANCE-ROOT-AND-GREAT-NINE-RECONCILIATION-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Reality root governance failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "GOVERNANCE ROOT AND GREAT NINE RECONCILIATION PASS"
