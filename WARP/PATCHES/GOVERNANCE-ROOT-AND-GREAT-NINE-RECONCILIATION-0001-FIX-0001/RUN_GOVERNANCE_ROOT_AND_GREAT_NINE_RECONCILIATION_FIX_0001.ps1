...
$Validator = Join-Path $RepoRoot "ORGANS\MECHANICUS\VALIDATORS\validate_reality_root_governance.py"

Write-Host "== GOVERNANCE-ROOT-AND-GREAT-NINE-RECONCILIATION-0001-FIX-0001 =="
...
if ($LASTEXITCODE -ne 0) { throw "Reality root governance FIX-0001 failed with exit code $LASTEXITCODE" }

Remove-Item -Recurse -Force "ORGANS\MECHANICUS\VALIDATORS\__pycache__" -ErrorAction SilentlyContinue

Write-Host "GOVERNANCE ROOT AND GREAT NINE RECONCILIATION FIX-0001 PASS"
