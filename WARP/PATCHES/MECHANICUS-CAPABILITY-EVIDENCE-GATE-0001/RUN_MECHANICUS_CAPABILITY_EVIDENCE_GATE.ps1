...
$PatchId = "MECHANICUS-CAPABILITY-EVIDENCE-GATE-0001"
...
$Validator = Join-Path $RepoRoot "ORGANS/MECHANICUS/VALIDATORS/validate_mechanicus_capability_evidence_gate.py"
python $Validator --repo-root $RepoRoot
if ($LASTEXITCODE -ne 0) {
  throw "Mechanicus capability evidence gate failed with exit code $LASTEXITCODE"
}

Write-Host "MECHANICUS CAPABILITY EVIDENCE GATE PASS" -ForegroundColor Green
