# PASS_WARN_BLOCK_VERDICT_MATRIX — V0.4 Candidate

Owner organ: `Inquisition`
Support organs: `Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/INQUISITION/MATRICES/PASS_WARN_BLOCK_VERDICT_MATRIX.md`

## Purpose
Normalizes PASS/WARN/BLOCK with hard gates and caps.
