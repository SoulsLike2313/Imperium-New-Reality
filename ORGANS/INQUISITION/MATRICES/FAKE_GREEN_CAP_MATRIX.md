# FAKE_GREEN_CAP_MATRIX — V0.4 Candidate

Owner organ: `Inquisition`
Support organs: `Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/INQUISITION/MATRICES/FAKE_GREEN_CAP_MATRIX.md`

## Purpose
Defines global and local caps that prevent unsupported PASS.
