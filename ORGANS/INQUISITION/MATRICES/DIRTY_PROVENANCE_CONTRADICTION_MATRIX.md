# DIRTY_PROVENANCE_CONTRADICTION_MATRIX — V0.4 Candidate

Owner organ: `Inquisition`
Support organs: `Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/INQUISITION/MATRICES/DIRTY_PROVENANCE_CONTRADICTION_MATRIX.md`

## Purpose
Detects dirty tracked outputs, stale receipts, head mismatch, provenance contradictions.
