# SECURITY_PRIVATE_BOUNDARY_MATRIX — V0.4 Candidate

Owner organ: `Inquisition`
Support organs: `Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/INQUISITION/MATRICES/SECURITY_PRIVATE_BOUNDARY_MATRIX.md`

## Purpose
Protects private/local data boundaries, no secret export, no accidental context leakage.
