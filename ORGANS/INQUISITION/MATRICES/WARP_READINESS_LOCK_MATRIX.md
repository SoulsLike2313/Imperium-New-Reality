# WARP_READINESS_LOCK_MATRIX — V0.4 Candidate

Owner organ: `Inquisition`
Support organs: `Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/INQUISITION/MATRICES/WARP_READINESS_LOCK_MATRIX.md`

## Purpose
Locks WARP until role, dirty/provenance, tool, route, and replay gates are strong enough.
