# ROLE_ROUTE_MATRIX — V0.4 Candidate

Owner organ: `Officio Agentis`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/OFFICIO_AGENTIS/MATRICES/ROLE_ROUTE_MATRIX.md`

## Purpose
Defines how GPT/Logos/Servitor enters role from Git link, reads authority, and produces ACK.
