# CAPABILITY_SPLIT_HARNESSABILITY_MATRIX — V0.4 Candidate

Owner organ: `Mechanicus`
Support organs: `Inquisition, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/MECHANICUS/MATRICES/CAPABILITY_SPLIT_HARNESSABILITY_MATRIX.md`

## Purpose
Classifies claims as script-first, manual command, candidate script, agent-only, external, Owner-confirmed, or future gap.
