# SCRIPT_FIRST_ADOPTION_MATRIX — V0.4 Candidate

Owner organ: `Mechanicus`
Support organs: `Inquisition, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/MECHANICUS/MATRICES/SCRIPT_FIRST_ADOPTION_MATRIX.md`

## Purpose
Decides when repeated agent reasoning must become script/checker/validator.
