# PLAYWRIGHT_SEMANTIC_PARITY_MATRIX — V0.4 Candidate

Owner organ: `Mechanicus`
Support organs: `Inquisition, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/MECHANICUS/MATRICES/PLAYWRIGHT_SEMANTIC_PARITY_MATRIX.md`

## Purpose
Defines semantic DOM/check/view-model/screenshot parity for Agent IDE/Sanctum-like surfaces.
