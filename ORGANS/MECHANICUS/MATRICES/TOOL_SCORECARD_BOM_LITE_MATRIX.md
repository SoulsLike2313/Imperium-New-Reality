# TOOL_SCORECARD_BOM_LITE_MATRIX — V0.4 Candidate

Owner organ: `Mechanicus`
Support organs: `Inquisition, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/MECHANICUS/MATRICES/TOOL_SCORECARD_BOM_LITE_MATRIX.md`

## Purpose
Tracks tool availability, version, owner, risk, replay examples, and admission status.
