# VISUAL_BLOCK_SPINE_ACCEPTANCE_MATRIX — V0.4 Candidate

Owner organ: `Officio Agentis`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/OFFICIO_AGENTIS/MATRICES/VISUAL_BLOCK_SPINE_ACCEPTANCE_MATRIX.md`

## Purpose
Separates visual polish score from truth score and defines owner-facing UX acceptance.

## Used by
INQUISITOR, GPT_LOGOS, SERVITOR, OWNER
