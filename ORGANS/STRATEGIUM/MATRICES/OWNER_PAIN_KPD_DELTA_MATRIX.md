# OWNER_PAIN_KPD_DELTA_MATRIX — V0.4 Candidate

Owner organ: `Strategium`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/STRATEGIUM/MATRICES/OWNER_PAIN_KPD_DELTA_MATRIX.md`

## Purpose
Measures whether tasks reduce Owner pain and improve useful KPD, not only file count.
