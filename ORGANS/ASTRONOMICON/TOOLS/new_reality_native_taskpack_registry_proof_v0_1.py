...
def main() -> int:
    ...
    native_intake = {
        ...
        "original_registration_proof": intake.get("original_registration_proof", not intake.get("reused_existing_smoke", False)),
        "fresh_registration_in_this_run": intake.get("fresh_registration_in_this_run", not intake.get("reused_existing_smoke", False)),
        "reused_existing_smoke": intake.get("reused_existing_smoke", False),
        "source_zip_path_for_replay": intake.get("source_zip_path_for_replay", ""),
