...
def build_response(task_id: str, question: str, mode: str) -> Dict[str, Any]:
    ...
    if "owner verdict" in lowered or "owner decision" in lowered or "override" in lowered:
        ...
        owner_q = "Нужно ли Owner-решение для изменения стейдж-маршрута вне зарегистрированной формы?"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Wave2 ASTRONOMICON organ query tool.")
