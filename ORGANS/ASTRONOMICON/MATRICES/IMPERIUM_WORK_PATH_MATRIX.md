# IMPERIUM_WORK_PATH_MATRIX — V0.4 Candidate

Owner organ: `Astronomicon`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/ASTRONOMICON/MATRICES/IMPERIUM_WORK_PATH_MATRIX.md`

## Purpose
Maps work from Owner intent through role entry, task route, organ packets, execution, rescan, and closure.
