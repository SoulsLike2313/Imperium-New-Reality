# OWNER_QUESTION_MATRIX — V0.4 Candidate

Owner organ: `Astronomicon`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/ASTRONOMICON/MATRICES/OWNER_QUESTION_MATRIX.md`

## Purpose
Captures questions blocking score precision, routes them to Owner, and records decisions.
