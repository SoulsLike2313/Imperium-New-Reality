...
SURFACE = "WEB_SANCTUM_STAGE_LOOP_POLISH_AND_COPY_CONTOUR_V0_8_1"
VERSION = "0.8.1"
...
ACTION_DEFS = {
    ...
    for item in [
        ...
        action("run_playwright", "Run Playwright", "evidence", "playwright:test", ["playwright", "test"], "WEB_SANCTUM", 300, True, ["E:/IMPERIUM_LOCAL_HANDOFF/SERVITOR_OUTPUTS"], "EVIDENCE_OUTPUT_ONLY", ["playwright_results", "html_report"]),
        action("run_playwright_screenshots", "Collect screenshots", "evidence", "playwright:screenshots", ["playwright", "test", "web_sanctum_screenshots.spec.ts"], "WEB_SANCTUM", 300, True, ["E:/IMPERIUM_LOCAL_HANDOFF/SERVITOR_OUTPUTS"], "EVIDENCE_OUTPUT_ONLY", ["owner_visible_screenshots"]),
    ...
    return [
        {
            ...
            "summary": (item.get("result") or {}).get("reason") or (item.get("result") or {}).get("verdict") or (item.get("result") or {}).get("message") or "",
