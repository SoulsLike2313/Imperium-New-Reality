# EVIDENCE_STRENGTH_MATRIX — V0.4 Candidate

Owner organ: `Administratum`
Support organs: `Inquisition, Mechanicus`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/ADMINISTRATUM/MATRICES/EVIDENCE_STRENGTH_MATRIX.md`

## Purpose
Defines E0-E6 evidence levels and score caps.
