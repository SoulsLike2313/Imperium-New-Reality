# FILE_KIND_CLASSIFICATION_MATRIX — V0.4 Candidate

Owner organ: `Administratum`
Support organs: `Inquisition, Mechanicus`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/ADMINISTRATUM/MATRICES/FILE_KIND_CLASSIFICATION_MATRIX.md`

## Purpose
Converts UNKNOWN file kinds into owned file classes and risk/cleanup actions.
