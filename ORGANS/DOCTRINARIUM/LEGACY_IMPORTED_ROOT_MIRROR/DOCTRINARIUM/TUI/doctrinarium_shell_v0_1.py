...
def _load_theme(organ_id: str) -> dict[str, str]:
    ...
    fallback = {"identity": organ_id, "accent": "yellow", "header": "bold yellow", "panel": "yellow", "prompt": "yellow"}
...
def build_config() -> dict[str, Any]:
    return {
        ...
        "query_script": NEWGEN_ROOT / "DOCTRINARIUM" / "TOOLS" / "doctrinarium_organ_query_v0_1.py",
        "report_root": NEWGEN_ROOT / "REPORTS" / TASK_ID_DEFAULT,
        "mission_focus": "Hold gate truth and doctrinal scope boundaries without fake green.",
        "specific_commands": {
            "laws": "Show doctrine law stack and gate authority",
            "preflight": "Run bounded doctrinarium preflight",
        },
        "theme": _load_theme("DOCTRINARIUM"),
    }
