...
def build_response(task_id: str, question: str, mode: str) -> Dict[str, Any]:
    ...
    if "owner verdict" in lowered or "owner decision" in lowered:
        verdict = "OWNER_VERDICT_NEEDED"
        owner_question = "Нужен ли Owner override для выхода за границы Wave 1?"
    elif "skip preflight" in lowered or "generic pass" in lowered:
        verdict = "BLOCK"
    ...
    payload = build_verdict_payload(
        ...
        not_proven=[
            ...
            "Astronomicon/Inquisition TUI in this task",
            "production autonomy",
        ],
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Wave1 Doctrinarium organ query tool.")
    parser.add_argument("--task-id", default=TASK_ID_DEFAULT)
    parser.add_argument("--question", default="What laws and gates apply to this task?")
...
def main() -> int:
    ...
    if args.sample:
        question = "What laws and gates apply to this task?"
