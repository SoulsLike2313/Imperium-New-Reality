# CANON_ADMISSION_MATRIX — V0.4 Candidate

Owner organ: `Doctrinarium`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/DOCTRINARIUM/MATRICES/CANON_ADMISSION_MATRIX.md`

## Purpose
Defines candidate/proposed-canon/canon admission boundary and future Throne/Custodes locks.
