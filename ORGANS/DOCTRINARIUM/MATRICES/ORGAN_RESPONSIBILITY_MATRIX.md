# ORGAN_RESPONSIBILITY_MATRIX — V0.4 Candidate

Owner organ: `Doctrinarium`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/DOCTRINARIUM/MATRICES/ORGAN_RESPONSIBILITY_MATRIX.md`

## Purpose
Separates organ authority so matrices do not become one central unreadable pile.
