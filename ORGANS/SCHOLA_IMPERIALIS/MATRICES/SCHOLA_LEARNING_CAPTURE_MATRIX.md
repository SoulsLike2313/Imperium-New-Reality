# SCHOLA_LEARNING_CAPTURE_MATRIX — V0.4 Candidate

Owner organ: `Schola Imperialis`
Support organs: `Inquisition, Mechanicus, Administratum`
Status: `CANDIDATE`
Candidate repo location: `IMPERIUM_NEW_GENERATION/ORGANS/SCHOLA_IMPERIALIS/MATRICES/SCHOLA_LEARNING_CAPTURE_MATRIX.md`

## Purpose
Captures lessons, reusable mistakes, anti-patterns, and future training items.
