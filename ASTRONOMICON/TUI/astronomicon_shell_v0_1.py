...
def _load_theme(organ_id: str) -> dict[str, str]:
    ...
    fallback = {"identity": organ_id, "accent": "magenta", "header": "bold magenta", "panel": "magenta", "prompt": "magenta"}
...
def build_config() -> dict[str, Any]:
    return {
        ...
        "query_script": NEWGEN_ROOT / "ASTRONOMICON" / "TOOLS" / "astronomicon_organ_query_v0_1.py",
        "report_root": NEWGEN_ROOT / "REPORTS" / TASK_ID_DEFAULT,
        "mission_focus": "Route tasks through explicit stage maps and owner-linked criteria.",
        "specific_commands": {
            "route": "Show organ route plan for current task",
            "stages": "Show shell execution stage template",
        },
        "theme": _load_theme("ASTRONOMICON"),
    }
