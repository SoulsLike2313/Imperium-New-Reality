...
def _load_theme(organ_id: str) -> dict[str, str]:
    ...
    fallback = {"identity": organ_id, "accent": "red", "header": "bold red", "panel": "red", "prompt": "red"}
...
def build_config() -> dict[str, Any]:
    return {
        ...
        "query_script": NEWGEN_ROOT / "MECHANICUS" / "TOOLS" / "mechanicus_organ_query_v0_1.py",
        "report_root": NEWGEN_ROOT / "REPORTS" / TASK_ID_DEFAULT,
        "mission_focus": "Forge and validate capability truth before any execution claim.",
        "specific_commands": {
            "tools": "Show tool capability registry summary",
            "capability": "Probe Rich capability health",
        },
        "theme": _load_theme("MECHANICUS"),
    }
