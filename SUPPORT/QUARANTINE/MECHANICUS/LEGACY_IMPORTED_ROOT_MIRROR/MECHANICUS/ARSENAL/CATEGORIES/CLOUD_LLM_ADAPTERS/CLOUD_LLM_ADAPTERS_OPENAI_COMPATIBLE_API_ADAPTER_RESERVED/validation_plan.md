# Validation Plan — CLOUD_LLM_ADAPTERS_OPENAI_COMPATIBLE_API_ADAPTER_RESERVED
...
Planned command key: `validate:cloud-llm-adapters-openai-compatible-api-adapter-reserved`
